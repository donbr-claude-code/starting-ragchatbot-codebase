...
class RAGSystem:
    ...
    def query(self, query: str, session_id: Optional[str] = None) -> Tuple[str, List[str], Dict[str, str]]:
        """
        ...
        Returns:
            Tuple of (response, sources list, source_links dict)
        """
        ...
        # Return response with sources and source links from tool searches
